...
{
    public const long UnhandledException = 1001;
    public const long NotFoundException = 1002;
    public const long BusinessLogicException = 1003;
    public const long NullException = 1004;
